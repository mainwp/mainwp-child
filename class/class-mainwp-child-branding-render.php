...
class MainWP_Child_Branding_Render {
	...
	public function contact_support() {
		...
		if ( isset( $_GET['from_page'] ) ) {
			...
			$fullurl   = isset( $_SERVER['HTTP_HOST'] ) && isset( $_SERVER['REQUEST_URI'] ) ? $protocol . sanitize_url( wp_unslash( $_SERVER['HTTP_HOST'] ) ) . sanitize_text_field( wp_unslash( $_SERVER['REQUEST_URI'] ) ) : '';
