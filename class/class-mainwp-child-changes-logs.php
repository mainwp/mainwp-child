...
class MainWP_Child_Changes_Logs {
    ...
    public static function get_changes_data() {
        ...
        if ( class_exists( '\MainWP\Child\Changes\Helpers\Changes_Sync_Data_Helper' ) ) {
            return \MainWP\Child\Changes\Helpers\Changes_Sync_Data_Helper::get_events_data( $limit, $params );
        }
        return '';
    }
}
