...
class MainWP_Child_IThemes_Security {
    ...
    public function whitelist() {
		...
		$ip       = isset( $_POST['ip'] ) ? sanitize_text_field( wp_unslash( $_POST['ip'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
		$add_temp = false;
    ...
    public function change_database_prefix() {
		...
		if ( isset( $_POST['change_prefix'] ) && 'yes' === $_POST['change_prefix'] ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
    ...
    public function release_lockout() {
		...
		$lockout_ids = array_map( 'sanitize_text_field', wp_unslash( $_POST['lockout_ids'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended
    ...
    public function update_module_status() {
		...
		$active_modules = isset( $_POST['active_modules'] ) ? array_map( 'sanitize_text_field', wp_unslash( $_POST['active_modules'] ) ) : array(); // phpcs:ignore WordPress.Security.NonceVerification.Recommended
