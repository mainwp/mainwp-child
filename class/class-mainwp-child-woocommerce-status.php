...
class MainWP_Child_WooCommerce_Status {
    ...
    public function sync_data() {
        ...
        // Generate cache key.
        $cache_key = 'wc_sales_' . md5( implode( '_', $safe_statuses ) . '_' . $month_start . '_' . $month_end ); // NOSONAR - MD5 used for cache key generation only, not cryptographic (security) purposes.
        ...
        $cache_key_top = 'wc_top_seller_' . md5( implode( '_', $safe_statuses ) . '_' . $month_start . '_' . $month_end ); // NOSONAR - MD5 used for cache key generation only, not cryptographic (security) purposes.
    ...
    public function report_data() {
        ...
        // Generate cache key.
        $cache_key = 'wc_sales_' . md5( implode( '_', $safe_statuses ) . '_' . $start_date . '_' . $end_date ); // NOSONAR - MD5 used for cache key generation only, not cryptographic (security) purposes.
        ...
        // Generate cache key for top seller.
        $cache_key_top = 'wc_top_seller_' . md5( implode( '_', $safe_statuses ) . '_' . $start_date . '_' . $end_date ); // NOSONAR - MD5 used for cache key generation only, not cryptographic (security) purposes.
